...
import 'change_mpin/change_mpin.dart';
import 'forgot_pin/number_for_forgot_pin.dart';

class OldMpnScreen extends StatefulWidget {
  const OldMpnScreen({Key? key}) : super(key: key);

  @override
  State<OldMpnScreen> createState() => _OldMpnScreenState();
}

class _OldMpnScreenState extends State<OldMpnScreen> {
          ...
          Column(
            ...
            children: [
              ...
              CustomText(
                ...
                text: 'Enter your Old MPIN',
                fontSize: 32,
                fontWeight: FontWeight.w500,
              ),
              CustomText(
                horizontalPadding: 30.0,
                text: 'Enter current MPIN',
                fontSize: 16,
              ),
              Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: InkWell(
                          onTap: () {
                            NavRouter.push(context, NumberForForgotPin());
                          },
                          child: CustomText(
