...
import 'package:fintech_app/screens/black_bg_arrow_screens/forgot_pin/set_new_mpin.dart';
...
class OtpForForgotPin extends StatefulWidget {
  const OtpForForgotPin({Key? key}) : super(key: key);

  @override
  State<OtpForForgotPin> createState() => _OtpForForgotPinState();
}

class _OtpForForgotPinState extends State<OtpForForgotPin>
        ...
        children: [
          ...
          Container(
            ...
            child: CustomElevatedButton(
                ...
                onPress: () {
                  isButtonActive == true
                      ? NavRouter.pushReplacement(context, SetNewMPINScreen())
